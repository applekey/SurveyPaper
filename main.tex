...
This benchmark was run with a 29 GB data set on 20 "m1.xlarg" EC2 nodes with 4 cores each.  From the result, figure \ref{fig: sparkPerformance}.

\begin{figure}[h]
	\centering
	\includegraphics[scale=0.5]{images/sparkPerformance.png}
