...
Hadoop Map Reduce and Parallel DBMS systems compared in performance for two category of tasks.  The first, more read heavy and the second more computation heavy.  
