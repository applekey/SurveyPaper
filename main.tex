...
%Facebook typically load about 10 TB of compressed data per day.  Suppose that given 100 workers with each capable of performing two mappings concurently.  Using input splits of 256 MB,  a workload of 10 TB will require ~400 mapper invokes.  Also, lets suppose that each mapper takes 17 seconds to run, so in total 400 mappers will take ~520 seconds.  
%\par
